...
const EMBEDDED_AIRLINES = [
  ...
  { name: "SAS Scandinavian Airlines", fleetAge: 13.8 }, 
  { name: "Saudia", fleetAge: 7.9 }, 
  { name: "Singapore Airlines", fleetAge: 7.1 }, 
  { name: "South African Airways", fleetAge: 15.2 }, 
  { name: "Southwest Airlines", fleetAge: 11.6 }, 
  { name: "SriLankan Airlines", fleetAge: 11.3 }, 
  { name: "SWISS", fleetAge: 12.9 }, 
  { name: "TAP Air Portugal", fleetAge: 9.2 }, 
  { name: "Thai Airways", fleetAge: 13.7 }, 
  { name: "Turkish Airlines", fleetAge: 8.7 }, 
  { name: "United Airlines", fleetAge: 15.1 }, 
  { name: "Vietnam Airlines", fleetAge: 8.4 }, 
  { name: "Virgin Atlantic", fleetAge: 7.3 }, 
  { name: "Vueling", fleetAge: 6.1 }, 
  { name: "WestJet", fleetAge: 9.6 }, 
  { name: "Wizz Air", fleetAge: 5.8 },
];
